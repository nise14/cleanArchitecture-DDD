...
public class CreateCustomerCommandValidator : AbstractValidator<CreateCustomerCommand>
{
    public CreateCustomerCommandValidator()
    {
        ...
        RuleFor(r => r.PhoneNumber).NotEmpty().MaximumLength(3);
        RuleFor(r => r.Line1).NotEmpty().MaximumLength(20).WithName("Address Line 1");
        RuleFor(r => r.Line2).MaximumLength(20).WithName("Address Line 2");
